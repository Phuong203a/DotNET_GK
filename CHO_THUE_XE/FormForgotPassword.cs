...
namespace CHO_THUE_XE
{
    public partial class FormForgotPassword : Form
    {
        ...
        private void sendEmailCode(String email)
        {
            try
            {
                ICredentialsByHost credentials = new NetworkCredential("damphuong14092003@gmail.com", "bfhtzekicxpkmoge");
                ...
                mail.From = new MailAddress("damphuong14092003@gmail.com");
                mail.To.Add(email);
